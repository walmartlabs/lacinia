...
Field resolvers are how |lib| goes beyond data modelling to actually providing access to data.
...
It is only inside field resolvers that a |lib| application can connect to a database or
